...
<link rel="shortcut icon" href="./assets/img/logo.png" class="rounded-circle" width="10" height="10" type="image/x-icon">
...
<link href="assets/css/stylesss.css" rel="stylesheet">
