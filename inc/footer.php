...
<footer id="footer" class="footer">
  <div class="copyright">
    &copy; Copyright <strong><span>QuickCheck</span></strong>. Viva el fulboooooooooooo
  </div>
  ...
  <p class="has-text-centered mb-4 mt-3">
    ...
    <a data-mdb-ripple-init class="btn text-white btn-floating m-1" style="background-color: #0082ca;" href="https://linkedin.com" role="button"><i class="fab fa-linkedin-in"></i></a>
    <a data-mdb-ripple-init class="btn text-white btn-floating m-1" style="background-color: #333333;" href="https://github.com/AlejandroIdk" role="button"><i class="fab fa-github"></i></a>
  </p>
</footer>
